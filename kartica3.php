            ...
            <div class="container" id="pocetna">
                <header class="header">
                    <div class="img-wrapper">
                        <img src="images/kartica3.jpg"/>
                    </div>
                    <div class="banner">
                        <h1>Hotel Art</h1>
                        <p>Jedan od prvih radova našeg obrta bio je u Hotelu Art i obuhvatio je bojanje, održavanje zidova i prilagodbu dizajna. Ovi ključni početni radovi igraju značajnu ulogu u poboljšanju izgleda hostela i stvaranju ugodnog ambijenta za goste.</p>
